...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('categories::general.title-update') }}</small>
    </h1>
@endsection

@section('content')
    {!! $formCategory::model($category, [
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('categories::general.title-update') }}</h3>
            </div><!-- /.box-header -->
        ...
        <div class="box box-success">
            <div class="box-body">
                <div class="box-tools pull-right">
                    ...
                    <input type="submit" class="btn btn-success btn-xs" value="{{ $category->id ? trans('categories::general.button.edit') : trans('categories::general.button.create') }}" />
                </div>
